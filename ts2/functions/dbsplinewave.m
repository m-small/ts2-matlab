% This is a mex file for MATLAB. It calculates the derivative of the cardinal 
% B-spline wavelet function for a given (vector) set of parameters (for a 
...
%
% NOTE: If a vector 'x' is given with only one paramter 'ord'. We calculate 
%       the output of the derivative for values 'x' and order 'ord'.
%
