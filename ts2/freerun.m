function [y_test,y_pred,e_pred,e_driv]= freerun(z_test,start,time,noise,bounds)

% [y_test,y_pred,e_pred,e_driv]= freerun(z_test,start,time,noise,bounds)
...
if trace,
    wait=waitbar(0,'freerun : working...');
end;
