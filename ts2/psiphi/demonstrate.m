...
[z_pred,y_pred,e_pred,y_data,B,Bsc,C,Csc] = ...
    cva_analysis(y,4001,90,[1 2 3 6 9 12 18 24 36],3,3);
testdatum=4001; predtime=90; predvect=[1 2 3 6 9 12 18 24 36]; BNp=3; CNp=3;
save -v4 demo1 testdatum predtime predvect z_pred y_pred e_pred y_data B Bsc BNp C Csc CNp 
...
[z_pred,y_pred,e_pred,y_data,B,Bsc,C,Csc] = ...
    cva_analysis(y,4001,60,[1 2 3 6 9 12 18 24 36],3,3);
testdatum=4001; predtime=60; predvect=[1 2 3 6 9 12 18 24 36]; BNp=3; CNp=3;
save -v4 demo2 testdatum predtime predvect z_pred y_pred e_pred y_data B Bsc BNp C Csc CNp 
...
[z_pred,y_pred,e_pred,y_data,B,Bsc,C,Csc] = ...
    cva_analysis(y,4001,60,[1 2 3 6 9 12 18 24 36],3,3);
testdatum=4001; predtime=60; predvect=[1 2 3 6 9 12 18 24 36]; BNp=3; CNp=3;
save -v4 demo3 testdatum predtime predvect z_pred y_pred e_pred y_data B Bsc BNp C Csc CNp 
...
[z_pred,y_pred,e_pred,y_data,B,Bsc,C,Csc] = ... 
    cva_analysis(y,4001,60,[1 2 3 6 9 12 18 24 36],3,3);
testdatum=4001; predtime=60; predvect=[1 2 3 6 9 12 18 24 36]; BNp=3; CNp=3;
save -v4 demo4 testdatum predtime predvect z_pred y_pred e_pred y_data B Bsc BNp C Csc CNp 
